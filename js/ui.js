...
function buildJamContent(d) {
  ...
  return `
    ...
    <div class="report-grid">
      ...
      <span>Verzögerung:</span> <strong>${d.delay != null ? Math.round(d.delay / 60) + ' min' : 'N/A'}</strong>
    </div>
  `;
}
...
function buildIrregularityContent(d) {
  ...
  return `
    ...
    <div class="report-grid">
      ...
      <span>Verzögerung:</span> <strong>${d.delaySeconds != null ? Math.round(d.delaySeconds / 60) + ' min' : 'N/A'}</strong>
